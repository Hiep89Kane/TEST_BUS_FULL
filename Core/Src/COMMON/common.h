...
uint64_t DbWord_sbi(uint64_t Dword, uint8_t bit);
uint64_t DbWord_cbi(uint64_t Dword, uint8_t bit);
uint64_t DbWord_tbi(uint64_t Dword, uint8_t bit);
uint8_t  DbWord_rbi(uint64_t Dword, uint8_t bit);

uint64_t DbWord_wbi(uint64_t Dword, uint8_t bit, uint8_t boolean);
